                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li class="active"><a href="/lab/daftarCekLab"><i class="fa fa-table"></i> Cek Laboratorium</a></li>
                            <li><a href="/lab/daftarPasien"><i class="fa fa-table"></i> Daftar Pasien</a></li>
            ...
            <div class="container">
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <th>Hail Pemeriksaan</th>
                        <th>Nilai Normal</th>
                    </tr>
                    </thead>
                    <tbody>
                    @foreach($cekLab as $data)
                        <tr>
